...
#define SERVO_STEP_ANGLE                10.0f
#define SERVO_HORIZONTAL_MIN_ANGLE_DEG  15.0f
#define SERVO_HORIZONTAL_MAX_ANGLE_DEG  165.0f
#define SERVO_VERTICAL_MIN_ANGLE_DEG    15.0f
#define SERVO_VERTICAL_MAX_ANGLE_DEG    165.0f
